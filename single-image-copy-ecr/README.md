...
# Required. The source image to replicate. Accepts '<repo>', '<group>/<repo>',
# or 'cgr.dev/<group>/<repo>'.
source_image = "cgr.dev/your.org/nginx"
...
When the resources are created, only the selected image will be mirrored to
the ECR repository.
